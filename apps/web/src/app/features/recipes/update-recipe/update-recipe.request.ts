...
const updateRecipeIngredientRequestSchema = z
  .object({
  ...
  .openapi("UpdateRecipeIngredientRequest");
...
const updateRecipeStepRequestSchema = z
  ...
  .openapi("UpdateRecipeStepRequest");
...
export const updateRecipeParamsRequestSchema = z
  ...
  .openapi("UpdateRecipeParamsRequest");

export const updateRecipeBodyRequestSchema = z
  .object({
    name: z.string().trim().min(1).max(200).openapi({
    ...
    recipeIngredients: z
      .array(updateRecipeIngredientRequestSchema)
      .optional()
      .openapi({
        example: [
          {
    ...
    recipeSteps: z
      .array(updateRecipeStepRequestSchema)
      .optional()
      .openapi({
        example: [
          {
...
export type UpdateRecipeParamsRequest = z.infer<
  typeof updateRecipeParamsRequestSchema
>;

export type UpdateRecipeBodyRequest = z.infer<
  typeof updateRecipeBodyRequestSchema
>;

export type UpdateRecipeRequest = UpdateRecipeParamsRequest & {
  body: UpdateRecipeBodyRequest;
};
